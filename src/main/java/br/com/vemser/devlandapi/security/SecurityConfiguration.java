        ...
        http.headers().frameOptions().disable().and()
                ...
                .authorizeHttpRequests((authz) ->
                        authz.antMatchers("/", "/auth","/auth/cadastro").permitAll()
                                ...
                                .antMatchers(HttpMethod.GET, "/usuario/listar-se", "/usuario/byname","/contato/listar-seus-contatos", "/endereco/listar-seus-enderecos", "/seguidor/**", "/tecnologia/**").hasAnyRole("DEV", "EMPRESA", "ADMIN") // 2
                                .antMatchers(HttpMethod.DELETE, "/usuario/listar-se", "/usuario/byname","/contato/listar-seus-contatos",  "/endereco/listar-seus-enderecos", "/seguidor/**", "/contato/**", "/tecnologia/**").hasAnyRole("DEV", "EMPRESA", "ADMIN") // 2
